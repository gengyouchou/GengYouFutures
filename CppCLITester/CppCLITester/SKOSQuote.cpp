...
Void CppCLITester::SKOSQuote::btnQueryStocks_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    ...
    gridStocks->Columns["m_caExchangeNo"]->HeaderText = "���ҥN�X";
    gridStocks->Columns["m_caExchangeName"]->HeaderText = "���ҦW��";
    gridStocks->Columns["m_caStockNo"]->HeaderText = "�~�N�X";
    gridStocks->Columns["m_caStockName"]->HeaderText = "�~�W��";

    gridStocks->Columns["m_nOpen"]->HeaderText = "�}�L��";
    gridStocks->Columns["m_nHigh"]->HeaderText = "����";
    gridStocks->Columns["m_nLow"]->HeaderText = "�C��";
    gridStocks->Columns["m_nClose"]->HeaderText = "�����";
    gridStocks->Columns["m_dSettlePrice"]->HeaderText = "�����";
    gridStocks->Columns["m_nTickQty"]->HeaderText = "��q";
    gridStocks->Columns["m_nRef"]->HeaderText = "�Q����";

    gridStocks->Columns["m_nBid"]->HeaderText = "�R��";
    gridStocks->Columns["m_nBc"]->HeaderText = "�R�q";
    gridStocks->Columns["m_nAsk"]->HeaderText = "���";
    gridStocks->Columns["m_nAc"]->HeaderText = "��q";
    gridStocks->Columns["m_nTQty"]->HeaderText = "����q";
...
Void CppCLITester::SKOSQuote::btnTicks_Click(System::Object ^ sender, System::EventArgs ^ e)
{
    ...
    gridBest10Ask->Columns["m_nAskQty"]->HeaderText = "�i��";
    gridBest10Ask->Columns["m_nAskQty"]->Width = 60;
    gridBest10Ask->Columns["m_nAsk"]->HeaderText = "���";
    gridBest10Ask->Columns["m_nAsk"]->Width = 60;

    gridBest10Bid->Columns["m_nAskQty"]->HeaderText = "�i��";
    gridBest10Bid->Columns["m_nAskQty"]->Width = 60;
    gridBest10Bid->Columns["m_nAsk"]->HeaderText = "�R��";
