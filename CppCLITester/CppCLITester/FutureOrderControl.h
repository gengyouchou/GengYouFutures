...
namespace CppCLITester
{
    ...
    /// <summary>
    /// FutureOrderControl ���K�n
    /// </summary>
public
    ref class FutureOrderControl : public System::Windows::Forms::UserControl
    {
...
#pragma endregion
    ...
    protected:
    private:
        System::Windows::Forms::TextBox ^ txtOffsetQty;

    private:
        System::Windows::Forms::Label ^ label22;

    private:
        System::Windows::Forms::ComboBox ^ boxOffsetBuySell;

    private:
        System::Windows::Forms::Label ^ label21;

    private:
        System::Windows::Forms::TextBox ^ txtOffsetYearMonth;

    private:
        System::Windows::Forms::Label ^ label20;

    private:
        System::Windows::Forms::Button ^ btnSendTXOffset;
    ...
    private:
        System::Windows::Forms::ComboBox ^ comBox_CoinType;

    private:
        System::Windows::Forms::Button ^ btnGetFutureRights;

    private:
        System::Windows::Forms::GroupBox ^ groupBox5;

    private:
        System::Windows::Forms::Button ^ GetOpenInterest;

    private:
        System::Windows::Forms::Label ^ label23;

    private:
        System::Windows::Forms::Button ^ btnGetOpenInterestFormat;

    private:
        System::Windows::Forms::ComboBox ^ FormatBox;
    ...
    private:
        System::Windows::Forms::TextBox ^ txtDecreaseSeqNo;
    ...
    private:
        System::Windows::Forms::ComboBox ^ boxReserved;

    private:
        System::Windows::Forms::Label ^ label18;

    private:
        System::Windows::Forms::Button ^ btnSendFutureOrderCLR;

    private:
        System::Windows::Forms::ComboBox ^ boxNewClose;

    private:
        System::Windows::Forms::Label ^ label17;

    private:
        System::Windows::Forms::Button ^ btnSendFutureOrder;
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            this->label22->Text = L"�e�U�q";
            //
            // boxOffsetBuySell
            //
            this->boxOffsetBuySell->FormattingEnabled = true;
            this->boxOffsetBuySell->Items->AddRange(gcnew cli::array<System::Object ^>(2){L"�R", L"��"});
            ...
            this->FormatBox->Items->AddRange(gcnew cli::array< System::Object^  >(3) {
                L"1:����, L" 2 : 榡1 ", L" 3 :�榡2 " });
                ...
                this->boxReserved->Items->AddRange(gcnew cli::array<System::Object ^>(2){L"�L��", L"T�L�w��"});
                ...
                this->boxNewClose->Items->AddRange(gcnew cli::array<System::Object ^>(3){L"�s��", L"���", L"�۰�"});
                ...
                this->boxFlag->Items->AddRange(gcnew cli::array<System::Object ^>(2){L"�D���R", L"���R"});
