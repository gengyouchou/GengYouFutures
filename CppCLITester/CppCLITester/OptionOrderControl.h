...
namespace CppCLITester
{
    ...
    /// <summary>
    /// OptionOrderControl ���K�n
    /// </summary>
public
    ref class OptionOrderControl : public System::Windows::Forms::UserControl
    {
#pragma region ��
    public:
        // ����v�e�U
...
#pragma endregion
    ...
    private:
        System::Windows::Forms::Button ^ btnSendOptionOrderAsync;

    private:
        System::Windows::Forms::Button ^ btnSendOptionOrder;
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            this->boxFlag->Items->AddRange(gcnew cli::array<System::Object ^>(3){L"�s��", L"���", L"�۰�"});
