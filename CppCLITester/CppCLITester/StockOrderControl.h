...
namespace CppCLITester
{
    ...
    /// <summary>
    /// StockOrderControl ���K�n
    /// </summary>
public
    ref class StockOrderControl : public System::Windows::Forms::UserControl
    {
#pragma region ��
    public:
        // ��U��
...
#pragma endregion
    ...
    private:
        System::Windows::Forms::ComboBox ^ MarketBox;

    private:
        System::Windows::Forms::Label ^ label21;

    private:
        System::Windows::Forms::TextBox ^ txtDecreaseQty;

    private:
        System::Windows::Forms::Label ^ label13;

    private:
        System::Windows::Forms::Button ^ btnDecreaseQty;

    private:
        System::Windows::Forms::TextBox ^ txtDecreaseBookNo;
    ...
    private:
        System::Windows::Forms::ComboBox ^ boxCorrectSymbol;

    private:
        System::Windows::Forms::Label ^ label16;

    private:
        System::Windows::Forms::Button ^ btnCorrectPriceByBookNo;

    private:
        System::Windows::Forms::TextBox ^ txtCorrectBookNo;

    private:
        System::Windows::Forms::Label ^ label15;

    private:
        System::Windows::Forms::Button ^ btnCorrectPriceBySeqNo;

    private:
        System::Windows::Forms::ComboBox ^ boxCorrectTradeType;

    private:
        System::Windows::Forms::Label ^ label17;

    private:
        System::Windows::Forms::TextBox ^ txtCorrectPrice;

    private:
        System::Windows::Forms::Label ^ label18;

    private:
        System::Windows::Forms::TextBox ^ txtCorrectSeqNo;
    ...
    private:
        System::Windows::Forms::TextBox ^ txtBalanceQueryStockNo;

    private:
        System::Windows::Forms::Label ^ label10;

    private:
        System::Windows::Forms::Button ^ GetBalanceQueryReport;

    private:
        System::Windows::Forms::GroupBox ^ groupBox6;

    private:
        System::Windows::Forms::TextBox ^ txtAmountLimitStockNo;

    private:
        System::Windows::Forms::Label ^ label12;

    private:
        System::Windows::Forms::Button ^ btnGetAmountLimit;

    private:
        System::Windows::Forms::GroupBox ^ groupBox5;

    private:
        System::Windows::Forms::TextBox ^ txt_ProfitLossSeqNo;

    private:
        System::Windows::Forms::Label ^ label29;

    private:
        System::Windows::Forms::TextBox ^ txt_ProfitLossBookNo;

    private:
        System::Windows::Forms::Label ^ label28;

    private:
        System::Windows::Forms::TextBox ^ txt_ProfitLossYMEnd;

    private:
        System::Windows::Forms::Label ^ label27;

    private:
        System::Windows::Forms::TextBox ^ txt_ProfitLossYMStart;
    ...
    private:
        System::Windows::Forms::ComboBox ^ box_TradeType;

    private:
        System::Windows::Forms::TextBox ^ txt_ProfitLossStock;
    ...
    private:
        System::Windows::Forms::Button ^ btn_GetProfitLossGW;

    private:
        System::Windows::Forms::ComboBox ^ box_QueryType;

    private:
        System::Windows::Forms::ComboBox ^ box_format;

    private:
        System::Windows::Forms::Button ^ btnGetRequestProfitReport;

    private:
        System::Windows::Forms::GroupBox ^ groupBox3;

    private:
        System::Windows::Forms::Button ^ btnGetRealBalanceReport;

    private:
        System::Windows::Forms::GroupBox ^ groupBox2;

    private:
        System::Windows::Forms::Button ^ btnCancelOrderByBookNo;

    private:
        System::Windows::Forms::Button ^ btnCancelOrderBySeqNo;

    private:
        System::Windows::Forms::TextBox ^ txtCancelBookNo;

    private:
        System::Windows::Forms::TextBox ^ txtCancelSeqNo;
    ...
    private:
        System::Windows::Forms::TextBox ^ txtCancelStockNo;

    private:
        System::Windows::Forms::CheckBox ^ ckboxAsyn;

    private:
        System::Windows::Forms::CheckBox ^ ckboxDecreaseAsyn;
    ...
    private:
        System::Windows::Forms::Button ^ StockOddOrderAsync;

    private:
        System::Windows::Forms::Button ^ StockOddOrder;

    private:
        System::Windows::Forms::TextBox ^ QtyOdd;

    private:
        System::Windows::Forms::TextBox ^ PriceOdd;

    private:
        System::Windows::Forms::ComboBox ^ comboBox4;

    private:
        System::Windows::Forms::ComboBox ^ BoxOddPeriod;

    private:
        System::Windows::Forms::ComboBox ^ BuySellBoxOdd;

    private:
        System::Windows::Forms::TextBox ^ StockNoOdd;
    ...
    private:
        System::Windows::Forms::Button ^ btnSendStockOrder;

    private:
        System::Windows::Forms::GroupBox ^ �U��;
    ...
    private:
        System::Windows::Forms::ComboBox ^ boxSpecialTradeType;

    private:
        System::Windows::Forms::Label ^ label7;

    private:
        System::Windows::Forms::ComboBox ^ boxCond;

    private:
        System::Windows::Forms::Label ^ label6;

    private:
        System::Windows::Forms::ComboBox ^ boxFlag;

    private:
        System::Windows::Forms::Label ^ label5;

    private:
        System::Windows::Forms::ComboBox ^ boxPeriod;

    private:
        System::Windows::Forms::Label ^ label4;

    private:
        System::Windows::Forms::ComboBox ^ boxBidAsk;

    private:
        System::Windows::Forms::Label ^ label3;

    private:
        System::Windows::Forms::ComboBox ^ boxPrime;

    private:
        System::Windows::Forms::Label ^ label2;

    private:
        System::Windows::Forms::TextBox ^ txtStockNo;
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            this->�U�� = (gcnew System::Windows::Forms::GroupBox());
            ...
            // �U��
            //
            this->�U��->Controls->Add(this->ckboxAsyn);
            this->�U��->Controls->Add(this->txtQty);
            this->�U��->Controls->Add(this->btnSendStockOrder);
            this->�U��->Controls->Add(this->label9);
            this->�U��->Controls->Add(this->txtPrice);
            this->�U��->Controls->Add(this->label8);
            this->�U��->Controls->Add(this->boxSpecialTradeType);
            this->�U��->Controls->Add(this->label7);
            this->�U��->Controls->Add(this->boxCond);
            this->�U��->Controls->Add(this->label6);
            this->�U��->Controls->Add(this->boxFlag);
            this->�U��->Controls->Add(this->label5);
            this->�U��->Controls->Add(this->boxPeriod);
            this->�U��->Controls->Add(this->label4);
            this->�U��->Controls->Add(this->boxBidAsk);
            this->�U��->Controls->Add(this->label3);
            this->�U��->Controls->Add(this->boxPrime);
            this->�U��->Controls->Add(this->label2);
            this->�U��->Controls->Add(this->txtStockNo);
            this->�U��->Controls->Add(this->label1);
            this->�U��->Location = System::Drawing::Point(12, 21);
            this->�U��->Name = L"�U��";
            this->�U��->Size = System::Drawing::Size(888, 123);
            this->�U��->TabIndex = 2;
            ...
            this->boxSpecialTradeType->Items->AddRange(gcnew cli::array<System::Object ^>(2){L" ( 1���� )", L" ( 2���� )"});
            ...
            this->label6->Text = L"�e�U����";
            //
            // boxFlag
            //
            this->boxFlag->FormattingEnabled = true;
            this->boxFlag->Items->AddRange(gcnew cli::array< System::Object^  >(4) {
                L"�{��, L"��
                ", L"�Ĩ�
                ", L"�L��
                " });
                ...
                this->label5->Text = L"���R�P�_";
                //
                // boxPeriod
                //
                this->boxPeriod->FormattingEnabled = true;
                this->boxPeriod->Items->AddRange(gcnew cli::array<System::Object ^>(3){L"���", L"�L��", L"�s��"});
                ...
                this->label4->Text = L"�e��覡";
                //
                // boxBidAsk
                //
                this->boxBidAsk->FormattingEnabled = true;
                this->boxBidAsk->Items->AddRange(gcnew cli::array<System::Object ^>(2){L"�R", L"��"});
                ...
                this->label3->Text = L"�R��O";
                //
                // boxPrime
                //
                this->boxPrime->FormattingEnabled = true;
                this->boxPrime->Items->AddRange(gcnew cli::array<System::Object ^>(2){L"�W���d", L"���d"});
                ...
                this->ckboxDecreaseAsyn->Text = L"�D�P�B";
                ...
                this->btn_GetProfitLossGW->Text = L"GetProfitLossGW(�s)";
                ...
                this->box_QueryType->Items->AddRange(gcnew cli::array<System::Object ^>(3){L"����{", L"�w�{", L"�{�ѷ��R�l�q"});
                ...
                this->box_format->Items->AddRange(gcnew cli::array<System::Object ^>(4){L"0:Summary", L"1:Detail", L"2:(��{)����`�B", L"3:(�{)�J�`BY�Ѳ��N��"});
                ...
                this->groupBox9->Text = L"��L���s��";
                //
                // comboBox3
                //
                this->comboBox3->FormattingEnabled = true;
                this->comboBox3->Items->AddRange(gcnew cli::array<System::Object ^>(1){L"�W���d"});
                ...
                this->comboBox4->Items->AddRange(gcnew cli::array<System::Object ^>(1){L"�{��"});
                ...
                this->BoxOddPeriod->Items->AddRange(gcnew cli::array<System::Object ^>(1){L"�L���s��"});
                ...
                this->BuySellBoxOdd->Items->AddRange(gcnew cli::array<System::Object ^>(2){L"�R", L"��"});
